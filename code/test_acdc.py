...
parser.add_argument('--exp', type=str, default='ACDC', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "../model/ACDC_{}_{}_{}_labeled".format(FLAGS.model, FLAGS.exp, FLAGS.labeled_num)
    test_save_path = "../model/ACDC_{}_{}_{}_labeled/predictions/".format(FLAGS.model, FLAGS.exp, FLAGS.labeled_num)
